...
https://github.com/maplibre/maplibre-gl-leaflet/blob/main/leaflet-maplibre-gl.js
...
const LeafletMaplibreGL = L.Layer.extend({
  options: {
      updateInterval: 32,
      ...
      interactive: false,
      // set the overlayPane as the default pane to draw gl tiles above base tiles
      pane: 'overlayPane'
  },
...
export default LeafletMaplibreGL
